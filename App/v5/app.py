...
unhealthy_duration = 45  # The app will be unhealthy for the first 45 seconds
...
def healthz():
    ...
    if current_time - start_time >= 90:  # Now requires 90 seconds to become healthy
        app_health = "healthy"
        return jsonify(status="healthy"), 200
    else:
        log_message = {"message": "The application requires 90 seconds to start."}
